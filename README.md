...
<code>apt update && apt install git python3 -y && git clone https://github.com/CoderLifeData/Heroku && cd Heroku && pip install -r requirements.txt && python3 -m hikka</code><br.>
